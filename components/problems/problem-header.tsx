...
export function ProblemHeader({
	...
	// 진행률 계산
	const progressValue = ((currentProblemIndex + 1) / totalProblems) * 100;
		...
		<div className="px-4 py-3 flex flex-col justify-center items-center">
			<Popover>
				<PopoverTrigger asChild>
					<Button
						variant="ghost"
						className="flex flex-col items-center gap-4 h-full text-lg"
					>
						<div className="flex items-center gap-4">
							<span className="font-medium flex-shrink-0">{subjectName}</span>
							<NumberFlowGroup>
								<div
				...
				<PopoverContent className="w-full p-2">
					<div className="space-y-4">
						<div className="flex gap-2 justify-center">
							...
							<Button variant="ghost" size="icon" onClick={onGiveUp}>
